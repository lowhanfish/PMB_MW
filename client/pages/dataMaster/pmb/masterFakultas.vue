  ...
  <div class="mainPage">
    <v-container>
      <v-card class="mx-auto" outlined>
        <v-row class="barPage">
          <v-col cols="12" md="4">
            <span class="h_judul">Master Fakultas</span>
            <br />
  ...
  export default {
    ...
    methods: {
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_DM_masterFakultas + "view", {
            method: "POST",
            headers: {
      ...
      addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_DM_masterFakultas + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_DM_masterFakultas + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : async function(data){
        ...
        fetch(this.$store.state.url.URL_DM_masterFakultas + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
