  ...
  <div class="mainPage">
    <v-container>
      <v-card class="mx-auto" outlined>
        <v-row class="barPage">
          <v-col cols="12" md="4">
            <span class="h_judul">Master Tahun Akademik</span>
            <br />
  ...
  export default {
    ...
    methods: {
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_DM_master_tahun + "view", {
            method: "POST",
            headers: {
      ...
      addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_DM_master_tahun + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_DM_master_tahun + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : async function(data){
        ...
        fetch(this.$store.state.url.URL_DM_master_tahun + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
