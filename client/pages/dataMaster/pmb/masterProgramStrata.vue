  ...
  <div class="mainPage">
    <v-container>
      <v-card class="mx-auto" outlined>
        <v-row class="barPage">
          <v-col cols="12" md="4">
            <span class="h_judul">Master Program Strata</span>
            <br />
          ...
          <template v-slot:default>
            <thead style="background:#5289E7">
              <tr class="h_table_head">
                ...
                <th class="text-left" style="width:50%">Fakultas</th>
                <th class="text-left" style="width:20%">Singkatan</th>
          ...
          <v-card>
            ...
            <v-card-text>
              ...
              <v-container>
                ...
                <v-text-field v-model="form.singkatan" class="placeholerku" label="Singkatan" outlined dense required/>
  ...
  export default {
    ...
    methods: {
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_DM_master_program_strata + "view", {
            method: "POST",
            headers: {
      ...
      addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_DM_master_program_strata + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_DM_master_program_strata + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : async function(data){
        ...
        fetch(this.$store.state.url.URL_DM_master_program_strata + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
