  ...
  <div class="mainPage">
    <v-container>
      <v-card class="mx-auto" outlined>
        <v-row class="barPage">
          <v-col cols="12" md="4">
            <span class="h_judul">Tahapan Pendaftaran</span>
            <br />
  ...
  export default {
    ...
    methods: {
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_MAIN_dokTahapPendaftaran + "view", {
            method: "POST",
            headers: {
      ...
      addData : function(number) {
        this.form.tahun_id = this.filter.tahun_id;
        fetch(this.$store.state.url.URL_MAIN_dokTahapPendaftaran + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_MAIN_dokTahapPendaftaran + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : async function(data){
        ...
        fetch(this.$store.state.url.URL_MAIN_dokTahapPendaftaran + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      selectData : async function(data){
          this.form.dokTahapPendaftaran_id = data.dokTahapPendaftaran_id;
