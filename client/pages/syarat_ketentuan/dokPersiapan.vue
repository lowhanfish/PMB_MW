  ...
  <div class="mainPage">
    <v-container>
      <v-card class="mx-auto" outlined>
        <v-row class="barPage">
          <v-col cols="12" md="4">
            <span class="h_judul">Dokumen Persiapan</span>
            <br />
  ...
  export default {
    ...
    methods: {
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_MAIN_dokPersiapan + "view", {
            method: "POST",
            headers: {
      ...
      addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_MAIN_dokPersiapan + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_MAIN_dokPersiapan + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : async function(data){
        ...
        fetch(this.$store.state.url.URL_MAIN_dokPersiapan + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      selectData : async function(data){
          this.form.dokPersiapan_id = data.dokPersiapan_id;
